...
[![PR Validation](https://img.shields.io/github/workflow/status/austomos/oauth2-chaster-app/CI?label=PR%20Validation&logo=github)](https://github.com/austomos/oauth2-chaster-app/actions?query=workflow%3ACI)
